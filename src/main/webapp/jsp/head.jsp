    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            <c:if test="${empty user}">
                ...
                <li><a href="${pageContext.request.contextPath}/user?method=cartUi">我的购物车</a></li>
            </c:if>
            <c:if test="${not empty user}">
                <li><a href="${pageContext.request.contextPath}/order?method=selectMyOrdersByPage&pageNumber=1">我的订单</a></li>
...
<%--                    使用ajax异步请求--%>
                ...
                <form action="${pageContext.request.contextPath}/product" method="post" class="navbar-form navbar-right" role="search">
